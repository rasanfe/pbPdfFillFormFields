...
PUBLIC:
String is_assemblypath = "DotNet\PdfFillFormFields\PdfFillFormFields.dll"
...
event constructor;is_assemblypath = gs_dir + "DotNet\PdfFillFormFields\PdfFillFormFields.dll"
end event
